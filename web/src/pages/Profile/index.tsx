...
import { Container, Content, AvatarInput, ThemeContainer } from './styles';
...
const Profile: React.FC = () => {
  ...
  const handleToggleTheme = useCallback(async () => {
    await api.patch('/users/theme', user.id).then((response) => {
        ...
        >
          ...
          <ThemeContainer>
            <Switch
              ...
              checked={checkTheme}
            />
            {user.theme === 'dark' ? <h3>Tema Escuro</h3> : <h3>Tema Claro</h3>}
          </ThemeContainer>
        </Form>
      </Content>
    </Container>
